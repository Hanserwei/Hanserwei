...
**Backend Engineering · Open Source · AI Agents**
...
我主要关注后端工程与分布式系统，日常使用 Java 和 Spring 生态构建服务，也在通过 Rust、Go 与 Python 拓宽技术边界。最近尤其关注 AI Agent、开发者工具，以及如何把复杂系统做得更可靠、更容易维护。
